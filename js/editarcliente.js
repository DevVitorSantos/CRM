(function(){
  ...
  function obtenerCliente(id){
    //deixando o obbj store pronto para mexer na base de dados
    ...
    cliente.onsuccess = function(e){
      ...
      if(cursor){
        if(cursor.value.id  == Number(id) ) {
          ...
          console.log('este é o registro', cursor.value);
        }
        cursor.continue()
      }
    }
  ...
  // conecta no db e deixa a variavel DB pronta para iniciar o transaction
  function conectarDB() {
